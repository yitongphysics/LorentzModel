...
string tetraFile = pathname + "100_42_tetra.txt";
string inputFile = pathname + "100_42.pos";
...
int main(int argc, char const *argv[]) {
    if (argc > 1){
        ...
        string transitionFileStr =   argv[6];
        ...
        stringstream transitionFileSS(transitionFileStr);
        ...
        inputSS >> inputFile;
        transitionFileSS >> transitionFile;
    }
